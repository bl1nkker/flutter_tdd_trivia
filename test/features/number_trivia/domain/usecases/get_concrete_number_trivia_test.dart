...
import 'package:flutter_tdd_trivia/features/number_trivia/domain/usecases/get_concrete_number_trivia.dart';
...
void main() {
  ...
  final tNumber = 1;
  final tNumberTrivia = NumberTrivia(text: 'This is one', number: tNumber);
